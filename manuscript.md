...
performance [@Wisz2013RolBio]. In other words, interactions directly improve
prediction of distribution for individual species. Categories of approaches to
...
SDMs with dynamic models [@Araujo2007ImpBio]. Improving SDMs through
...
[@Foden2016IucSsc]. They represent an important methodological advance to come.
Interactions are also considered as a key element of the functional role of a
species, which must be considered for the evaluation of species recovery and the
development of an IUCN Green List of recovered species [@Akcakaya2018QuaSpe].
IPBES recognizes models for performing scenario analyses and projecting regional
biodiversity dynamics under IPBES will need to incorporate species interactions
and community dynamics, which will benefit global and regional IPBES assessments
